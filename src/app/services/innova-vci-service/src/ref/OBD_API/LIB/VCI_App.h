...
/*------------------------------------------------------------------------------
Engineer               : Nguyen Thi Hoa Cuc , HungVo modified 31July2010
...
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: void gf_VCI_KW1281_DisableACKCmd(void)
 *Input        :
 *Output       :
 *Description  :
 *disable function send ack to ecu
 *auto reset to default after linking
 *notice this function will make data missing
 *Historical   :
 *     1. Creation HungVo Apr 27, 2016  9:58:20 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VCI_KW1281_DisableACKCmd(void);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: structResponseBuffer * gf_VCI_FordUBPLink(structLinkProfile * p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo May 30, 2016  1:52:52 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
structResponseBuffer * gf_VCI_FordUBPLink(structLinkProfile * p_strtLinkProfile);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: structResponseBuffer* gf_VCI_DaewooKW_Init(structLinkProfile * p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *Init KW of Daewoo
 ...
 *
 *Historical   :
 *     1. Creation HungVo  2:10:22 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
structResponseBuffer* gf_VCI_DaewooKW_Init(structLinkProfile * p_strtLinkProfile);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: void gf_VPWSetTriggerFunction(enumbool (*pfunction)(structJ1850Frame *strtJ1850Frame,uint8 bNumberFrame))
 *Input        :
 *Output       :
 *Description  :
 *This function will autoreset anytime implement
 *
 *
 *Historical   :
 *     1. Creation HungVo  9:46:00 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VPWSetTriggerFunction(enumbool (*pfunction)(structJ1850Frame *strtJ1850Frame,uint8 bNumberFrame));


/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: void gf_VCI_KWSetMaxLinkTime(uint32 Second)
 *Input        :
 *Output       :
 *Description  :
 *use to set custom maximum linking time live
 *default will be  3 minute if get negative 78 / 21
 *Auto reset Linked Time to default when get out function
 *Historical   :
 *     1. Creation HungVo  11:10:45 AM
 *
 ...
 *
 -------------------------------------------------------------------------------*/
void gf_VCI_KWSetMaxLinkTime(uint32 Second);

structResponseBuffer * gf_VCI_OBDTruck_J1939Link_OnClameAddr(structLinkProfile * p_strtLinkProfile,uint32 tMs);
#endif /* VCI_APP_H_ */
