...
#define VERSION_PROTOCOL_LIB_ 	"OBD API V01.01.39"
#endif
 ...
 *
 *Historical   :
 *     1. Creation HungVo Apr 20, 2016  10:13:22 AM
 *
 *
 *
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo Apr 26, 2016  10:10:20 AM
 *
 *
 *
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo Apr 26, 2016  11:25:00 AM
 *
 *
 *
 *
...
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: uint8 gf_VDM_GetIdxOfOemProfile(structOemProfile *pstrtoemprofile)
 *Input        :
 *Output       :
 *Description  :
 *get index of oemprofile in list oem profiles
 *
 *
 *Historical   :
 *     1. Creation HungVo  1:27:34 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
uint8 gf_VDM_GetIdxOfOemProfile(structOemProfile *pstrtoemprofile);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: void gf_VCI_Disable_OBD2_ParseOffSet(void)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  11:57:50 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VCI_Disable_OBD2_ParseOffSet(void);
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: void gf_VCI_ResetToDefault_OBD2_ParseOffSet(void)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  11:57:54 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VCI_ResetToDefault_OBD2_ParseOffSet(void);
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: enumbool gf_VCI_GetOBD2ParseOffSet(void)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  11:57:20 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VCI_GetOBD2ParseOffSet(void);
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: enumbool gf_VDM_Resp_Get_LiveDataFormat(void)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  11:53:49 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VDM_Resp_Get_LiveDataFormat(void);
#endif
