...
Engineer        : HungVo - Created 17 Jan 2011
History         :

|-Version     |   Date       |  Engineer   |        Note                     -|
  +V01.00.00    17Jan2011         HungVo      *Initialize
  +V01.00.01    20Jan2011         HungVo      fixed align memory,pack...
  +V01.00.02    24Feb2011         HungVo      added field eDLCRxPinName in DLC profile
  +V01.00.03    28Feb2011         HungVo      added protocol PROTOCOL_KW476 Renault ABS
  +V01.00.04    18May2011         HungVo      synchronize enumprotocol with R&D V01.00.30
  +
  +
  +
===============================================================================
...
typedef struct _structRequestBuffer
{
    ...
    //uint8   arrReserve[8];
    uint8   IgnoreModeH;//Effect on Honda 99B
    uint8   __arrReserve[4];
    uint16  sCntNegFrame;
    uint8	EnableQuickExit;
...
#define __Kline_Resitor(ar,br,cr)   p_strtLinkProfile->strtKlineInitParam.strtDLCTx.eResitor=ar;\
    p_strtLinkProfile->strtKlineInitParam.strtDLCRx.eResitor=br;\
    p_strtLinkProfile->strtKlineInitParam.strtDLCInit.eResitor=cr
...
typedef struct _structLinkProfile
{
    ...
    */
    ...
    // void (*pfVCIBusyNotify)(void);
    // void (*pfEnterToSystemMode)(void);
    // void (*pfLeaveToSystemMode)(void);
} structLinkProfile;
#pragma pack()
...
typedef enum _enumEcuInfoPrcSt
{
	...
	ECUINFO_ECU_CRASH=5,/*ECU Is Crashed , Need Recycle Key*/
} enumEcuInfoPrcSt;
...
typedef enumbool(*pfunctionLinkFrameHandle)(structLinkProfile * p_strtLinkProfile,void *pFrameData);
...
enumbool gf_VBI_Resp_x_IsPositive(structLinkProfile * p_strtLinkProfile,uint8 bNoBuff);
enumbool gf_VBI_Resp_IsPositive(structLinkProfile * p_strtLinkProfile);
 ...
 *
 *Historical   :
 *     1. Creation HungVo Mar 17, 2016  1:27:39 PM
 *
 *
 *
 *
...
/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: enumNegStatus gf_VBI_RespStrtGetNegStatus(structResponseBuffer *p_strtResponseBuffer)
 *Input        :
 *Output       :
 *Description  :
 *get negative status of struct response buffer
 *
 *
 *Historical   :
 *     1. Creation HungVo  2:47:31 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumNegStatus gf_VBI_RespStrtGetNegStatus(structResponseBuffer *p_strtResponseBuffer);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name: enumbool gf_VBI_RespStrtIsPossitive(structResponseBuffer*pstrtRespBuff)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  8:14:57 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VBI_RespStrtIsPossitive(structResponseBuffer*pstrtRespBuff);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name:void gf_VBI_Config_QuickExit(structLinkProfile *p_strtLinkProfile,enumbool IsEnable)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  3:23:33 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VBI_Config_QuickExit(structLinkProfile *p_strtLinkProfile,enumbool IsEnable);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name:enumbool gf_VBI_IsEnableQuickExit(structLinkProfile *p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation HungVo  3:23:41 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VBI_IsEnableQuickExit(structLinkProfile *p_strtLinkProfile);

/*------------------------------------------------------------------------------
 *Engineer     : HungVo
 *Function name:enumbool gf_VBI_IsBreakByQuickExit(structLinkProfile *p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VBI_IsBreakByQuickExit(structLinkProfile *p_strtLinkProfile);


void gf_VCI_RegisterFrameHandle(pfunctionLinkFrameHandle functionx);
void gf_VCI_UnRegisterFrameHandle(void);
enumbool gf_VCI_HandleFrame(structLinkProfile * p_strtLinkProfile,void *pFrameData);
...
-----------------------------------------------------------------------------*/
uint16 gf_VCI_GetNegCount(structLinkProfile * p_strtLinkProfile);

void gf_VCI_Honda9x_SetIgnoreModeH(structLinkProfile * p_strtLinkProfile,enumbool isEnable);

void gf_SYS_NotifyBusy(structLinkProfile * p_strtLinkProfile);
void gf_SYS_SystemMode_Enter(structLinkProfile * p_strtLinkProfile);
void gf_SYS_SystemMode_Leave(structLinkProfile * p_strtLinkProfile);

typedef void(*FunctionLogData)(enumProtocol eProtocol,void*pdataObj,uint32 iLen,enumbool isReq);

void gf_Debug_Log_Register(FunctionLogData fx);
void gf_Debug_Log(enumProtocol eProtocol,void*pdataObj,uint32 iLen,enumbool isReq);

#define LOG_REQ(eProtocol,pdataObj,iLen)    gf_Debug_Log(eProtocol,pdataObj,iLen,eTRUE)
#define LOG_RES(eProtocol,pdataObj,iLen)    gf_Debug_Log(eProtocol,pdataObj,iLen,eFALSE)


void gf_SYS_EnterToSystemMode_Register(fFunction pf);
void gf_SYS_LeaveToSystemMode_Register(fFunction pf);
void gf_SYS_NotifyBusy_Register(fFunction pf);
