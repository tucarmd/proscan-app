...
typedef enumResitor	enumPUResitor;
typedef enumPd_Resitor	enumPDResitor;
...
#define PU_511	eresitor_PU_511
#define PU_NONE	eresitor_PU_NONE
#define PU_4K7	eresitor_PU_4K7

#define PU_2K7	eresitor_PU_2K7
#define PU_1K	eresitor_PU_1K
#define PU_2K	eresitor_PU_2K
...
#define PD_NONE epd_resitor_PD_NONE
#define PD_OPEN epd_resitor_PD_OPEN
#define PD_2K8 epd_resitor_PD_2K8
#define PD_3K9 epd_resitor_PD_3K9
#define PD_10K epd_resitor_PD_10K
