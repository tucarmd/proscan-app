...
{
    NOTIFY_OBD2_QUERY_INFO  ="NOTIFY_OBD2_QUERY_INFO",
    NOTIFY_DEBUG_LOG        ="NOTIFY DEBUG LOG",
    NOTIFY_DEBUG_LOG_COM_TX ="DEBUG TX",
    NOTIFY_DEBUG_LOG_COM_RX ="DEBUG RX",
    NOTIFY_DEBUG_LOG_COM_RX_RX = "DEBUG RX RX", //added by ngoclb
    NOTIFY_VCI_DATA_RESPONSE="VCI DATA RESPONSE"
};

export interface NotifyDataType
{
    tag:EnumNotify,
    data:any
};

export enum EnumSerialType
{
  Serial_USB =0,
  Bluetooth =1
}

export const enumDataFrameType = {
    unknowFrame: 0,
    RespFrameACK: 1,
    ReqFrameACK: 2,
    NotifyFrame: 3,
...
export const ENUM_NOTIFY_EVENTS =
{
  UNKNOW: 0,
  IGNITION_ON_OFF: 1,
  BATTERY_WARNING: 2,
...
export const ENUM_EVENTIDTYPES = {
  Engine_status: 0x04,
...
export const ENUM_EVENTTYPEDATA = {
  Ignition: 'Ignition',
