...
export enum enumProtocol{
    eprotocol_UNKNOWN   = -1, // changed by ngoclb
...
export enum enumPd_Resitor{
    epd_resitor_UNKNOWN   = 0,
    epd_resitor_PD_NONE  = 0,
    epd_resitor_PD_OPEN  = 1,
    epd_resitor_PD_2K8  = 2,
    epd_resitor_PD_3K9  = 3,
    epd_resitor_PD_10K  = 4,
};


export enum enumResitor{
    eresitor_UNKNOWN   = 0,
    eresitor_PU_NONE  = 0,
    eresitor_PU_511  = 1,
    eresitor_PU_2K7  = 2,
...
export enum enumDtcdisplaytype{
	...
	edtcdisplaytype_DTC_MAIN_DEC_5DIGIT_SAE_AUTO_SUB_DEC_3=36,
	edtcdisplaytype_MitsubishiDTC=37,
};


export enum enumInnovagroup{
