import { LoggingService, Logger as IonicLogger, LocalStorageAppender } from 'ionic-logging-service';
...
export class LoggerService {
  ...
  public removeLogMessages = () => this.loggingService.removeLogMessages();

  public getStoredLogMessage = () => {
    const appenderList = new IonicLogger()?.getInternalLogger()?.getEffectiveAppenders();
