...
public class BluetoothSerial extends CordovaPlugin {
    ...
    // Android 23 requires user to explicitly grant permission for bluetooth to
    // discover unpaired
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals(LIST)) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
                ...
                try {
                    fineLocation = args.getBoolean(0) || false;
                } catch (Exception e1) {
                }
                if ((!fineLocation || (cordova.hasPermission(ACCESS_FINE_LOCATION) && fineLocation))
                        && cordova.hasPermission(BLUETOOTH_SCAN) && cordova.hasPermission(BLUETOOTH_CONNECT)) {
                    ...
                    permissionGrantedExecuteArgs = args;
                    permissionCallbackContext = callbackContext;
                    cordova.requestPermission(this, CHECK_PERMISSIONS_REQ_CODE_ACCESS_FINE_LOCATION,
                ...
                if (cordova.hasPermission(ACCESS_COARSE_LOCATION)) {
                    ...
                    permissionGrantedExecuteArgs = args;
                    permissionCallbackContext = callbackContext;
                    cordova.requestPermission(this, CHECK_PERMISSIONS_REQ_CODE_ACCESS_COARSE_LOCATION,
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions,
        ...
        // This way the plugin can ask for all the permissions and launch the proper
        // method when granted, base on why the
