(function () {
  ...
  (self["webpackChunkcom_carmd_proscan2"] = self["webpackChunkcom_carmd_proscan2"] || []).push([["node_modules_ionic_core_dist_esm_ion-button_2_entry_js"], {
    /***/
    10570:
    /*!*************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var getNamedUrl = function getNamedUrl(iconName) {
        ...
        return (0, _index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.k)("svg/".concat(iconName, ".svg"));
      };
      ...
      var Button = /*#__PURE__*/function () {
        function Button(hostRef) {
          ...
          this.handleClick = function (ev) {
            ...
            if (_this.type === 'button') {
              (0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.o)(_this.href, ev, _this.routerDirection, _this.routerAnimation);
              ...
              if (!formEl && form !== undefined) {
                ...
                if (typeof form === 'string') {
                  (0, _index_c4b11676_js__WEBPACK_IMPORTED_MODULE_3__.p)("Form with selector: \"#".concat(form, "\" could not be found. Verify that the id is correct and the form is rendered in the DOM."), el);
                } else {
        ...
        return _createClass(Button, [{
          ...
          value: function render() {
            ...
            var mode = (0, _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
            ...
            return (0, _index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "class": (0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, (_ref2 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_ref2, mode, true), buttonType, true), "".concat(buttonType, "-").concat(expand), expand !== undefined), "".concat(buttonType, "-").concat(finalSize), finalSize !== undefined), "".concat(buttonType, "-").concat(shape), shape !== undefined), "".concat(buttonType, "-").concat(fill), true), "".concat(buttonType, "-strong"), strong), 'in-toolbar', (0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-toolbar', this.el)), 'in-toolbar-color', (0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-toolbar[color]', this.el)), 'in-buttons', (0, _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-buttons', this.el)), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_ref2, 'button-has-icon-only', hasIconOnly), 'button-disabled', disabled), 'ion-activatable', true), 'ion-focusable', true)))
        ...
        return _createClass(Icon, [{
          ...
          value: function render() {
            ...
            return (0, _index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({
              ...
              role: "img",
              "class": Object.assign(Object.assign(_defineProperty({}, mode, true), createColorClasses(this.color)), _defineProperty(_defineProperty({}, "icon-".concat(this.size), !!this.size), 'flip-rtl', !!flipRtl && isRTL(el)))
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var openURL = /*#__PURE__*/function () {
        var _ref = (0, _Users_tucarmd_DATA_PROJECTS_proscan_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, ev, direction, animation) {
          var router;
